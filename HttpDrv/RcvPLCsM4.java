...
public class RcvPLCsM4
{
	...
	public RcvPLCsM4(byte[] Rx,String id,String resource) throws Exception
	{
		Connection c = null;
		Statement stmt = null;
		...
		//else
		{
			while(str.length()>=268 && Plc<4)
			{
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,value,typ,lstchg) VALUES (\'/"+id+"/PLC"+Plc+"/Status\',\'"+modo[Modo]+Flags+"\','StrR',LOCALTIMESTAMP);"; //"+Flags+"
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/SyncRef\',LOCALTIMESTAMP,\'"+SyncRef+"\','StrR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Cplan\',LOCALTIMESTAMP,\'"+Script+"\','StrR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Nombre\',LOCALTIMESTAMP,\'"+Name+"\','StrR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				try
				{
					if(resource.indexOf("gps")!=-1)
					{
						...
						sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Location\',LOCALTIMESTAMP,\'"+Location+",17\','GPS');"; 
						stmt.executeUpdate(sql);
					}
				}
				catch ( Exception x )
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/SchLstChg\',LOCALTIMESTAMP,\'"+schlstchg+"\','IntR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/SchNexChg\',LOCALTIMESTAMP,\'"+schnexchg+"\','IntR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				try
				{
					...
					sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Nplan\',LOCALTIMESTAMP,\'"+Plan+"\','IntR');"; 
					stmt.executeUpdate(sql);
				}
				catch ( Exception x )
				{
				...
				//----------------*/
				{
					...
					try
					{
						if(ErrorCode==0)
						{
							...
							sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Error\',LOCALTIMESTAMP,\'0,\','StrR');"; 
						}
						else
						{
							...
							sql = "INSERT INTO variables (id,lstchg,value,typ) VALUES (\'/"+id+"/PLC"+Plc+"/Error\',LOCALTIMESTAMP,\'"+ErrorCode+","+Error+"\','StrR');"; 
						}
						stmt.executeUpdate(sql);
					}
					catch ( Exception x )
			...
			while(Plc<=8)
			{
				sql="DELETE FROM variables WHERE id LIKE '/"+id+"/PLC"+Plc+"%' AND id LIKE '%Location%'";
				try
				{
					stmt.executeUpdate(sql);
				}
